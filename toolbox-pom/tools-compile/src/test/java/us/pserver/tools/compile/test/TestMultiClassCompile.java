...
import us.pserver.tools.compile.CompilingClassLoader;
 ...
 * @author juno
 */
public class TestMultiClassCompile {
  
  @Test
  public void test_multi_class_compile() {
    CompilingClassLoader loader = new CompilingClassLoader();
    ClassCompilation cpoint = new ClassCompilation("us.pserver.tools.compile.test.CPoint", loader);
    ...
    ClassCompilation cdim = new ClassCompilation("us.pserver.tools.compile.test.CDimension", loader);
    ...
    ClassCompilation crect = new ClassCompilation("us.pserver.tools.compile.test.CRectangle", loader);
