...
public class DcrCtu implements IDcrCtu {
  ...
  public int hashCode() {
    int hash = 7;
    hash = 59 * hash + Objects.hashCode(this.cdCtu);
    hash = 59 * hash + Objects.hashCode(this.txUrlCtu);
    return hash;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final DcrCtu other = (DcrCtu) obj;
    if (!Objects.equals(this.txUrlCtu, other.txUrlCtu)) {
      return false;
    }
    if (!Objects.equals(this.cdCtu, other.cdCtu)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    return "DcrCtu{" + "cdCtu=" + cdCtu + ", nmCtu=" + nmCtu + ", txUrlCtu=" + txUrlCtu + '}';
  }
