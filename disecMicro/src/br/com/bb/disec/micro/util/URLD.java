...
public class URLD {
  ...
  public static void main(String[] args) {
    String str = "http://intranet.bb.com.br/fluxotrb?autoselect=443";
    URLD urld = new URLD(str);
    System.out.println("Endereço: " + str);
    System.out.println("urld.getProtocol(): " + urld.getProtocol());
    System.out.println("urld.getHost(): " + urld.getHost());
    System.out.println("urld.getPort(): " + urld.getPort());
    System.out.println("urld.getContext(): " + urld.getContext());
    System.out.println("urld.getURI(): " + urld.getURI());
    System.out.println("urld.getPaths(): " + Arrays.toString(urld.getPaths()));
  }
